...
The database, named after *Unicorns*, utilised for this project is hosted at DataCamp's proprietary servers, and such, no data import work was necessary to undertake. The database consists of the following four tables:
...
1. What are the top three mysterious industries based upon the number of unicorn companies up to date?
